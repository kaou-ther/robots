...
eggbot = Robot.new(address: "20 Rue de la République, 67000 Strasbourg", name: "Eggbot", category: "cooking", description: "Eggs benedict, omelette, sunny side up, you name it, it does it all.", price: 230)
eggbot.user = richard
...
dishbot = Robot.new(address: "10 Rue du Palais, 25000 Besançon", name: "Dishbot", category: "cleaning", description: "So clean, so efficient. You will be surprised by their performance, and this without breaking anything.", price: 346)
dishbot.user = paul
...
grassbot = Robot.new(address: "25 Rue de la République, 13001 Marseille", name: "Grassbot", category: "gardening", description: "Mowing the lawn. Pff... A thing of the past! Let the specialist do it for you.", price: 754)
...
flowerbot = Robot.new(address: "35 Quai des Chartrons, 33000 Bordeaux", name: "Flowerbot", category: "gardening", description: "To take care of flowers you need a very delicate, highly specialized bot like this one.", price: 925)
...
plantprotectbot = Robot.new(address: "10 Place du Capitole, 31000 Toulouse", name: "Plant Protect Bot", category: "gardening", description: "No quarter for bugs around here with Plant Protect Bot", price: 650)
...
wateringbot = Robot.new(address: "10 Villa Gaudelet, 75011 Paris", name: "Wateringbot", category: "gardening", description: "This bot likes water and that is why it knows how to use it without waste.", price: 398)
