...
burgerbot = Robot.new(address: Faker::Address.full_address, address: Faker::Address.full_address, name: "Burgerbot", category: "cooking", description: "Mouth watering burgers on sight! Be prepared to melt!", price: 263)
...
pastabot = Robot.new(address: Faker::Address.full_address, name: "Pastabot", category: "cooking", description: "This robot will cook delicious pasta, as if you were sitting in a traditional restaurant in a small italian village. Pick the right wine and enjoy the ride!", price: 313)
...
pizzabot = Robot.new(address: Faker::Address.full_address, name: "Pizzabot", category: "cooking", description: "Probaly the most efficient of his generation. Up to 5 pizzas prepared and cooked per minute", price: 154)
...
donutbot = Robot.new(address: Faker::Address.full_address, name: "Donutbot", category: "cooking", description: "It will prepare for you doughnuts with a perfect geometrical form!!", price: 216)
...
eggbot = Robot.new(address: Faker::Address.full_address, name: "Eggbot", category: "cooking", description: "Eggs benedict, omelette, sunny side up, you name it, it does it all.", price: 230)
eggbot.user = richard
...
vacbot = Robot.new(address: Faker::Address.full_address, name: "Vacbot", category: "cleaning", description: "Nothing left on the floor after them.", price: 545)
vacbot.user = paul
...
swipebot = Robot.new(address: Faker::Address.full_address, name: "Swipebot", category: "cleaning", description: "You want it to shine? Let Swipebot do the work!", price: 522)
swipebot.user = paul
...
dustbot = Robot.new(address: Faker::Address.full_address, name: "Dustbot", category: "cleaning", description: "No more dust. Ever.", price: 620)
dustbot.user = paul
...
dishbot = Robot.new(address: Faker::Address.full_address, name: "Dishbot", category: "cleaning", description: "So clean, so efficient. You will be surprised by their performance, and this without breaking anything.", price: 346)
dishbot.user = paul
...
laundrybot = Robot.new(address: Faker::Address.full_address, name: "Laundrybot", category: "cleaning", description: "Always difficult to sort things out before washing them. This robot knows how to do it!", price: 246)
...
treebot = Robot.new(address: Faker::Address.full_address, name: "Treebot", category: "gardening", description: "Trees cut in all possible geometrical forms with Treebot!", price: 825)
treebot.user = joanne
...
grassbot = Robot.new(address: Faker::Address.full_address, name: "Grassbot", category: "gardening", description: "Mowing the lawn. Pff... A thing of the past! Let the specialist do it for you.", price: 754)
...
flowerbot = Robot.new(address: Faker::Address.full_address, name: "Flowerbot", category: "gardening", description: "To take care of flowers you need a very delicate, highly specialized bot like this one.", price: 925)
...
plantprotectbot = Robot.new(address: Faker::Address.full_address, name: "Plant Protect Bot", category: "gardening", description: "No quarter for bugs around here with Plant Protect Bot", price: 650)
...
wateringbot = Robot.new(address: Faker::Address.full_address, name: "Wateringbot", category: "gardening", description: "This bot likes water and that is why it knows how to use it without waste.", price: 398)
...
dogbot = Robot.new(address: Faker::Address.full_address, name: "Dogbot", category: "pet sitting", description: "Doggy likes Dogbot because it knows how to play!", price: 1205)
dogbot.user = steve
...
catbot = Robot.new(address: Faker::Address.full_address, name: "Catbot", category: "pet sitting", description: "Catbot can be sneaky; exactly the right kind of companion for you cat", price: 1562)
catbot.user = steve
...
parrotbot = Robot.new(address: Faker::Address.full_address, name: "Parrotbot", category: "pet sitting", description: "Yes, of course, it knows how to talk, and above all talk back!", price: 1998)
...
bunnybot = Robot.new(address: Faker::Address.full_address, name: "Bunnybot", category: "pet sitting", description: "For bunnies who like to be followed everywhere and always have a friend to play with", price: 1620)
bunnybot.user = steve
...
snakebot = Robot.new(address: Faker::Address.full_address, name: "Snakebot", category: "pet sitting", description: "Understanding snakes is not that easy, you should trust the specialists", price: 2996)
snakebot.user = marta
